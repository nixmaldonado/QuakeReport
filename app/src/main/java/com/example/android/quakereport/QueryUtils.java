...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        JSONArray jsonArray = extractJsonArrayFromJsonObject(convertStringToJsonObject());
    ...
    private static JSONObject convertStringToJsonObject(){
        try {
            return new JSONObject(SAMPLE_JSON_RESPONSE);
        } catch (JSONException e) {
    ...
    private static JSONArray extractJsonArrayFromJsonObject(JSONObject jsonObject){
        try {
            return jsonObject.getJSONArray("features");
        } catch (JSONException e) {
            Log.e("QueryUtils", "Problem extracting the Json Array", e);
            return null;
        }
    }
